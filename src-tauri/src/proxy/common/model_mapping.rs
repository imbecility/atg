...
//     m.insert("gpt-3.5-turbo-0613", "gemini-2.5-flash");
    ...
    m.insert("gemini-3.5-flash-medium", "gemini-3-flash-agent");
    m.insert("gemini-3.1-flash-lite", "gemini-3.1-flash-lite");
    m.insert("gemini-3.5-flash-extra-low", "gemini-3.5-flash-extra-low");
    m.insert("gemini-3-pro-thinking", "gemini-pro-agent");
    m.insert("gpt-oss-120b", "gpt-oss-120b-medium");

    m.insert("gemini-2.5-flash", "gemini-2.5-flash");
    m.insert("gemini-3-flash", "gemini-3-flash");
    m.insert("banana-2", "gemini-3.1-flash-image");
    m.insert("banana-pro", "gemini-3-pro-image");
    ...
    m.insert("internal-background-task", "gpt-oss-120b-medium");
    m
});
...
//     }
    ...
    if lower.contains("pro") && !lower.contains("image") {
        return Some("gemini-pro-agent".to_string());
    }
