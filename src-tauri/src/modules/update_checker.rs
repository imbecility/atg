...
const GITHUB_API_URL: &str = "https://api.github.com/repos/imbecility/atg/releases/latest";
const GITHUB_RAW_URL: &str = "https://raw.githubusercontent.com/imbecility/atg/main/package.json";
const JSDELIVR_URL: &str = "https://cdn.jsdelivr.net/gh/imbecility/atg@main/package.json";
...
const UPDATER_JSON_URL: &str = "https://github.com/imbecility/atg/releases/latest/download/updater.json";
...
async fn check_updater_json() -> Result<UpdateInfo, String> {
    ...
    let download_url = format!("https://github.com/imbecility/atg/releases/tag/v{}", latest_version);
...
async fn check_static_url(url: &str, source_name: &str) -> Result<UpdateInfo, String> {
    ...
    let download_url = "https://github.com/imbecility/atg/releases/latest".to_string();
